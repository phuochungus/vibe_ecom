...
type AuditLog struct {
	...
	BeforeData *string   `gorm:"column:before_data;type:jsonb" json:"before_data,omitempty"`
	AfterData  *string   `gorm:"column:after_data;type:jsonb" json:"after_data,omitempty"`
